...
public abstract class Packet
{
    ...
    public Packet(Header header, Client client)
    {
        this.header = header;
        this.client = client;
        staticClient = client;
    ...
    public String constructEncrypted(Value... arguments)
    {
        ...
        try {
            ...
            data = Value.construct("data", Server.instance.aes.encrypt(json.toString(), Server.instance.aes.getSecretKey(client)));
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public static Header readHeader(String packet) throws Exception {
